...
for name, lab in pairs(data.raw["lab"]) do
    ...
    lab_map[name] = {sciences = lab.inputs, items = {}}
    ...
    for _, science in pairs(lab.inputs) do
        ...
        for _, s in pairs (all_sciences) do
            if s == science then present = true break end
        end
        ...
        if not present then 
            ...
            for _, recipe in pairs(data.raw["recipe"]) do
                ...
                for _, result in pairs(recipe.results or {}) do
                    if result.type == "item" and result.name == science then recipe_produces_science = true break end
                end
                ...
                if recipe_produces_science then
                    for _, ingredient in pairs(recipe.ingredients or {}) do
                        ...
                        local toolname = item_map[recipe_ingredient.name]
